  ...
  <view-template id="start" align="end">
    ...
    <b-row>
      <b-col>
        ...
        <h1>Tiger Styles</h1>
        <p class="lead">
          Magically personalize your photos, using AI, with styles celebrating
          reunion with your friends. Have fun with it!
        </p>
      </b-col>
    </b-row>
    <template #footer>
      ...
      <b-row>
        <b-col>
          <p class="small text-muted">
            ...
            photos. (C) Princeton School of AI Reunion Project Group
          </p>
        </b-col>
      </b-row>
    </template>
